...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-mccoy-ranchocucamonga/';
  var LS_CHANGES = 'tf_mccoy_change_log_v1';
  var LS_PURCHASED = 'tf_mccoy_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Residential electrical, panel work, and wiring across Rancho Cucamonga and the Inland Empire. You get a fixed itemised quote before we start, Justin as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Justin at Mccoy Brothers Electric. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Justin at Mccoy Brothers Electric. Claim it, preview the rest of the journey, or request a change.';
    }
  }
